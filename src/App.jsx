  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        ...
        {needsKey && <Alert type="warn" msg="⚙️ 設定タブ�wOpenAI APIキーを入力してください" />}
        {posts.length < 2 && (
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        ...
        <div className="mb-5 mt-4">
          ...
          >
            ...
            <option value="gpt-4.1">gpt-4.1（最新ヹ高品質）</option>
          </select>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5">
        <p className="font-semibold text-blue-800 text-sm mb-3">💰 費用の目墉（gpt-4o-mini）</p>
...
export default function App() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-6 pb-16 min-h-screen">
      ...
      {postsError && (
        <div className="mb-4">
          <Alert type="error" msg={`データ取得エラー: ${postsError}`} />
        </div>
      )}
